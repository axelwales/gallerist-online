...
namespace TeamJAMiN.Controllers.GameLogicHelpers
{
    public static class ActionContextFactory
    {
        public static Dictionary<GameActionState, Type> ActionToContextType = new Dictionary<GameActionState, Type>
        {
            ...
            { GameActionState.SellChooseArt, typeof(SalesOfficeContext) },
            { GameActionState.SellChooseContract, typeof(SalesOfficeContext) },
            { GameActionState.SellChooseVisitor, typeof(SalesOfficeContext) },
            { GameActionState.TurnStart, typeof(SetupContext) },
